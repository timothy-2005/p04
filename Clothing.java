...
public class Clothing {
  ...
  public Clothing(String description, String brand, int timesWorn, LocalDate lastWornDate) {
    ...
    if (lastWornDate.getYear() < 1 || lastWornDate.getMonthValue() < 1
        || lastWornDate.getMonthValue() > 12) {
  ...
  public boolean equals(Object o) {
    if (o instanceof Clothing) {
      if (this.description.equalsIgnoreCase(((Clothing) o).getDescription())
          && this.brand.equalsIgnoreCase(((Clothing) o).getBrand())) {
        return true;
      }
    } else {
      return false;
  ...
  public String toString() {
    if (lastWornDate == null) {
      ...
      if (Integer.parseInt(day) < 10)
        day = "0" + day;
      return description + "," + brand + "," + month + '/' + day + "/" + lastWornDate.getYear()
          + "," + timesWorn;
    }
  }
}
